...
include('connect.php');//链接数据库
  //向数据库插入表单传来的值的sql
    $name=$_POST['name'];
    $sql1="insert into records values(null,'$name',now())";
    $sql2="select * from students where 姓名='$name'";
    mysqli_query($link,'set names utf8');
    if($name != "")
    $result=mysqli_query($link,$sql1);//执行sql
    $result=mysqli_query($link,$sql2);//执行sql
    // 输出数据
    while($row = mysqli_fetch_array($result)) {
      ...
      <div class='weui-cell__bd'><input class='weui-input' type='text' value='".$row['姓名']."' id='sno'></div></div>";
      echo "<div class='weui-cell'>
      <div class='weui-cell__hd'><label class='weui-label'>性别</label></div>
      <div class='weui-cell__bd'><input class='weui-input' type='text' value='".$row['性别']."' id='sno'></div></div>";  
      echo "<div class='weui-cell'>
      <div class='weui-cell__hd'><label class='weui-label'>出生日期</label></div>
      <div class='weui-cell__bd'><input class='weui-input' type='text' value='".$row['出生日期']."' id='sno'></div></div>";
      echo "<div class='weui-cell'>
      <div class='weui-cell__hd'><label class='weui-label'>院系</label></div>
      <div class='weui-cell__bd'><input class='weui-input' type='text' value='".$row['院系']."' id='sno'></div></div>";
      echo "<div class='weui-cell'>
      <div class='weui-cell__hd'><label class='weui-label'>专业</label></div>
      <div class='weui-cell__bd'><input class='weui-input' type='text' value='".$row['专业']."' id='sno'></div></div>";  
      echo "<div class='weui-cell'>
      <div class='weui-cell__hd'><label class='weui-label'>年级</label></div>
      <div class='weui-cell__bd'><input class='weui-input' type='text' value='".$row['年级']."' id='sno'></div></div>";  

      echo "<div class='weui-cell'>
      <div class='weui-cell__hd'><label class='weui-label'>班级</label></div>
      <div class='weui-cell__bd'><input class='weui-input' type='text' value='".$row['班级']."' id='sno'></div></div>";  
      echo "<div class='weui-cell'>
      <div class='weui-cell__hd'><label class='weui-label'>政治面貌</label></div>
      <div class='weui-cell__bd'><input class='weui-input' type='text' value='".$row['政治面貌']."' id='sno'></div></div>";  
      echo "<div class='weui-cell'>
      <div class='weui-cell__hd'><label class='weui-label'>学制</label></div>
      <div class='weui-cell__bd'><input class='weui-input' type='text' value='".$row['学制']."' id='sno'></div></div>";  
      echo "</div>";
        }
